  ...
  <div className="bg-white rounded-lg shadow p-6">
    <div className="flex justify-between items-start">
      <div>
        ...
        <p className="text-2xl font-bold text-sky-950/50 mt-1">{value}</p>
      </div>
...
export default function AdminDashboard() {
  ...
  return (
    <div className="p-6">
      <div className="mb-8">
        <h1 className="text-2xl font-bold text-sky-950">Dashboard Overview</h1>
        <p className="text-sky-950">Welcome back! Here&apos;s an overview of what&apos;s happening with your fleet.</p>
      </div>
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <p className="text-sm font-medium text-sky-950">New user registered</p>
                <p className="text-xs text-sky-950/40">5 minutes ago</p>
              </div>
            </div>
